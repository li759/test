...
from env.dead_end_detection import is_dead_end_scenario
DEBUG = False
if DEBUG:
...
class ParkingMapNormal(object):
    ...
    def reset(self, case_id: int=None, path: str=None) -> State:
        ...
        self.is_dead_end_scenario = is_dead_end_scenario(self.start, self.dest, self.obstacles)
    ...
    # Dead-end detection methods are now provided by env.dead_end_detection
